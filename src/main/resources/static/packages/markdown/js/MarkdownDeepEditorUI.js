...
// On line 80: TO-FIX: changed srcElement to currentTarget
//
...
var MarkdownDeepEditorUI=new function(){
    ...
    {
        // Initialize state: TO-FIX: changed srcElement to currentTarget
        var textarea=$(e.currentTarget).prevAll("textarea")[0];
